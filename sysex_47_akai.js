...
const parsers = [
	...
	['f0 47 10 00 5d', {
		...
		handler: (bytes) => {
			...
			console.assert(mfrId === 0x47 && deviceId === 0x10 && commandId === 0x00 && modelId === 0x5d);
	...
	['f0 47 10 01 5d', {
		...
		handler: (bytes) => {
			...
			console.assert(mfrId === 0x47 && deviceId === 0x10 && commandId === 0x01 && modelId === 0x5d);
	...
	['f0 47 10 42 5d', {
		...
		handler: (bytes) => {
			...
			console.assert(mfrId === 0x47 && deviceId === 0x10 && commandId === 0x42 && modelId === 0x5d);
